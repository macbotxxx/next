...
sentry_sdk.init(
    dsn="https://6adebbd5860f49edbfc580966aa470a9@o1074216.ingest.sentry.io/6073865",
...
MIGRATION_MODULES = {"sites": "next.contrib.sites.migrations"}
...
SESSION_TIMEOUT_REDIRECT = 'homepage'
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_SIGNUP_FORM_CLASS = 'next.users.forms.CustomSignupForm'
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "next.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "next.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
